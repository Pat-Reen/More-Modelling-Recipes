...
![Evolution of Tree-based Algorithms](img/tree_based_algorithms.jpeg)
...
![Golf in boosting](img/golf-gbdt.png)
...
# default hyper-parameters. Given the dataset is very imbalanced, 
# we use 'scale_pos_weight' to re-balance it which is the number of negative observations (i.e. "0") 
